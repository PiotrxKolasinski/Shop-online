...
public class SecurityController {
    ...
    @Autowired
    public SecurityController(UserDetailsManager userDetailsManager, PasswordEncoder passwordEncoder, CustomerService customerService) {
    ...
    public String processRegistration(@Valid @ModelAttribute("CrmUser") CrmUser crmUser, BindingResult bindingResult, Model model) {
